...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--nepochs_no_decay', type=int, default=40, help='# of epochs at starting learning rate')
        self._parser.add_argument('--nepochs_decay', type=int, default=40, help='# of epochs to linearly decay learning rate to zero')
